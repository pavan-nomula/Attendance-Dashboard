...
const FacultyLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Check if user is a faculty OR incharge (promoted faculty)
      if (!['faculty', 'incharge'].includes(response.user.role)) {
        setError('This is not a Faculty account. Please use the correct login page.');
        setLoading(false);
        return;
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center p-8">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 transform transition-transform hover:scale-105 duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Faculty Portal</h2>
